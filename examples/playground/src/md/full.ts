...
export const PocetKoupenych = {
     ...
     * Fact ID: fact.kancelarskepotreby.pocetkoupenych
     * Fact Aggregation: median
     */ Median: newMeasure(idRef("fact.kancelarskepotreby.pocetkoupenych", "fact"), (m) =>
        m.aggregation("median"),
    ),
    /**
     * Fact Title: Pocet Koupenych
     * Fact ID: fact.kancelarskepotreby.pocetkoupenych
     * Fact Aggregation: runsum
     */ Runsum: newMeasure(idRef("fact.kancelarskepotreby.pocetkoupenych", "fact"), (m) =>
        m.aggregation("runsum"),
    ),
};
/**
...
export const PocetRozdanych = {
     ...
     * Fact ID: fact.kancelarskepotreby.pocetrozdanych
     * Fact Aggregation: median
     */ Median: newMeasure(idRef("fact.kancelarskepotreby.pocetrozdanych", "fact"), (m) =>
        m.aggregation("median"),
    ),
    /**
     * Fact Title: Pocet Rozdanych
     * Fact ID: fact.kancelarskepotreby.pocetrozdanych
     * Fact Aggregation: runsum
     */ Runsum: newMeasure(idRef("fact.kancelarskepotreby.pocetrozdanych", "fact"), (m) =>
        m.aggregation("runsum"),
    ),
};
/**
