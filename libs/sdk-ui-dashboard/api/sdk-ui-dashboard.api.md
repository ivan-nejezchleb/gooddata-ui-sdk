...
// @internal (undocumented)
export const DefaultShareButtonInner: React_2.FC<WithIntlProps<WrappedComponentProps<"intl">>> & {
    WrappedComponent: React_2.ComponentType<WrappedComponentProps<"intl">>;
};
