...
export const Dashboard: React.FC<IDashboardProps> = (props: IDashboardProps) => {
    ...
    const widgetProvider = useCallback(
        (widget: ExtendedDashboardWidget, renderMode: RenderMode): CustomDashboardWidgetComponent => {
    ...
    const kpiProvider = useCallback(
        (kpi: ILegacyKpi, widget: IKpiWidget, renderMode: RenderMode): CustomDashboardKpiComponent => {
